(ns thornydev.cmblog.w3.user-dao
  (:require [monger.collection :as mc]
            [monger.result :as mres]
            [thornydev.cmblog.w3.password-util :refer [password-match? make-password-hash]]
            [thornydev.cmblog.w3.dao-config :refer [user-coll]])
